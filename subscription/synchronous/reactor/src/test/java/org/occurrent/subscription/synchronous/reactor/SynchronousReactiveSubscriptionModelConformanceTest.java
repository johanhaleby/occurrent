...
class SynchronousReactiveSubscriptionModelConformanceTest extends ReactiveSubscriptionModelConformance {

    @Override
    protected ReactiveSubscriptionModelFixture createFixture() {
        return new SynchronousReactiveSubscriptionModelFixture();
    }
}
