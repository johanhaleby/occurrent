...
@Testcontainers
class CatchupSubscriptionModelConformanceTest extends SubscriptionModelConformance {

    private static final String DATABASE = "catchupsubscriptionconformance";
    ...
    // What has to be fresh per test is the event collection and the checkpoint collection, which the fixture takes
    // care of.
