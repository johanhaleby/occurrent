...
@Testcontainers
class NativeMongoSubscriptionModelCheckpointConformanceTest extends CheckpointAwareSubscriptionModelConformance {

    private static final String DATABASE = "nativecheckpointconformance";
