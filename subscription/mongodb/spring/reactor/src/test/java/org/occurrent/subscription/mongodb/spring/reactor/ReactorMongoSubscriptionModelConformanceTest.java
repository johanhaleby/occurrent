...
/**
 * Reaches {@link ReactorMongoSubscriptionModel} through {@link org.occurrent.tck.subscription.reactor.BlockingSubscriptionOverReactive}.
 * Not the in-process suite: this model watches a MongoDB change stream, which is asynchronous by nature.
 */
@Testcontainers
class ReactorMongoSubscriptionModelConformanceTest extends SubscriptionModelConformance {

    private static final String DATABASE = "reactormongosubscriptionconformance";
