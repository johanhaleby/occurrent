...
public abstract class RegisteringSubscribable implements SubscriptionModel, IntrospectableSubscriptions {
    ...
    public interface RoutingAction {
        ...
        final class Refusal extends RuntimeException {
            ...
            /**
             * @param refusal   The real failure, rethrown unchanged once the outcome has been reported.
     ...
     * <p>
     * A {@link RoutingAction.Refusal} is a third thing again. The action was reached but refused before attempting
     * any dispatch, so it is never {@link RoutingOutcome#DELIVERED}, and the wrapped cause propagates once
     * {@code matchObserver} has been told. Which outcome is reported comes from the refusal itself,
