...
class CatchupThenPushReactiveSubscriptionModelConformanceTest extends ReactiveSubscriptionModelConformance {

    @Override
    protected ReactiveSubscriptionModelFixture createFixture() {
        return new CatchupThenPushReactiveSubscriptionModelFixture();
    }
}
