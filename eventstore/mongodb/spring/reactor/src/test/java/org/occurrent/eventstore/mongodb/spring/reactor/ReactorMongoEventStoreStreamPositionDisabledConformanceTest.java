...
import org.occurrent.tck.eventstore.blocking.StreamPositionDisabledConformance;
...
/**
 * Runs the blocking position-disabled suite against the reactive store through {@link BlockingEventStoreOverReactive},
 * so the scenarios are described once rather than a second time in terms of {@code Mono} and {@code Flux}.
 */
@Testcontainers
class ReactorMongoEventStoreStreamPositionDisabledConformanceTest extends StreamPositionDisabledConformance {
