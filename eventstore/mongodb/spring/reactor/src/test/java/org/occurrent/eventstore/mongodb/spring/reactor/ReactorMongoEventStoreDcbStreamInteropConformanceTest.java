...
/**
 * Runs the blocking DCB/stream interop suite against the reactive store through {@link BlockingEventStoreOverReactive},
 * so the scenarios are described once rather than a second time in terms of {@code Mono} and {@code Flux}.
 */
@Testcontainers
class ReactorMongoEventStoreDcbStreamInteropConformanceTest extends DcbStreamInteropConformance {
