...
import org.occurrent.tck.eventstore.blocking.StreamPositionConformance;
...
/**
 * Runs the blocking stream position suite against the reactive store through {@link BlockingEventStoreOverReactive},
 * so the contract is described once rather than a second time in terms of {@code Mono} and {@code Flux}.
 */
@Testcontainers
class ReactorMongoEventStoreStreamPositionConformanceTest extends StreamPositionConformance {
