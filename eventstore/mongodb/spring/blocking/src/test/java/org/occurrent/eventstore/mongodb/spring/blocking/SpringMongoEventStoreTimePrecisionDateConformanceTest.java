...
@Testcontainers
class SpringMongoEventStoreTimePrecisionDateConformanceTest extends EventStoreTimePrecisionConformance {
    ...
    protected EventStoreFixture createFixture() {
        ...
        return new SpringMongoEventStoreConformanceFixture(connectionString, TimeRepresentation.DATE);
    }
}
