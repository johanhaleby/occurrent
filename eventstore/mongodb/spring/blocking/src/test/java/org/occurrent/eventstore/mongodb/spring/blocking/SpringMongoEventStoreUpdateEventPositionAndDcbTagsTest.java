...
class SpringMongoEventStoreUpdateEventPositionAndDcbTagsTest {
    ...
    void create_mongo_template() {
        ...
        mongoTransactionManager = new MongoTransactionManager(new SimpleMongoClientDatabaseFactory(mongoClient, databaseName));
    }
    ...
    void updating_an_unpositioned_event_with_a_forged_position_leaves_it_unpositioned() {
        SpringMongoEventStore eventStore = new SpringMongoEventStore(mongoTemplate,
