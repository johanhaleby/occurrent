...
@Testcontainers
class MongoEventStoreStreamPositionDisabledConformanceTest extends StreamPositionDisabledConformance {
    ...
    protected EventStoreFixture createFixture() {
        return new MongoEventStoreConformanceFixture(new ConnectionString(mongoDBContainer.getReplicaSetUrl()), TimeRepresentation.RFC_3339_STRING);
    }
}
