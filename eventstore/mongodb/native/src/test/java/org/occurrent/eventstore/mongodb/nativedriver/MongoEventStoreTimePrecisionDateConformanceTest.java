...
@Testcontainers
class MongoEventStoreTimePrecisionDateConformanceTest extends EventStoreTimePrecisionConformance {
    ...
    protected EventStoreFixture createFixture() {
        return new MongoEventStoreConformanceFixture(new ConnectionString(mongoDBContainer.getReplicaSetUrl()), TimeRepresentation.DATE);
    }
}
