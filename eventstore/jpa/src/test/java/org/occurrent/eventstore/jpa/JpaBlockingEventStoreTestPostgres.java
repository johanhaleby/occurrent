...
@ContextConfiguration(classes = {JpaBlockingEventStoreTestPostgres.PGConfig.class, RepositoryConfig.class})
@ExtendWith(SpringExtension.class)
@Testcontainers
@TestInstance(TestInstance.Lifecycle. PER_CLASS)
class JpaBlockingEventStoreTestPostgres extends JpaBlockingEventStoreTestBase<JPAEventStore<CloudEventDao>> {
