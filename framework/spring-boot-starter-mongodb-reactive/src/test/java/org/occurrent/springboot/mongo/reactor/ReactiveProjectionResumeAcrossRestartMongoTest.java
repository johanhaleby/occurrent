...
class ReactiveProjectionResumeAcrossRestartMongoTest {
    ...
    static class DashboardProjection {
        @org.occurrent.annotation.Projection(id = "reactive-projection-resume-dashboard", startAt = org.occurrent.annotation.Projection.StartPosition.BEGINNING, resumeBehavior = org.occurrent.annotation.Projection.ResumeBehavior.DEFAULT)
