...
@SpringBootTest(
        classes = ReactiveSubscriptionModeManualDomainPushProjectionMongoTest.ManualDomainPushApplication.class,
        properties = {
                "occurrent.event-store.capabilities=stream",
                "occurrent.subscription.mode=manual",
                "occurrent.cloud-event-converter.cloud-event-source=urn:occurrent:reactive-manual-domain-push-projection-test"
        }
)
@Import(ReactiveSubscriptionModeManualDomainPushProjectionMongoTest.MongoDbContainerConfiguration.class)
@Testcontainers
@Timeout(60)
class ReactiveSubscriptionModeManualDomainPushProjectionMongoTest {

    private static final URI SOURCE = URI.create("urn:occurrent:reactive-manual-domain-push-projection-test");
    private static final String PROJECTION_ID = "reactive-manual-domain-push-order-count";
    ...
    static class ManualDomainPushApplication {
        @Bean
