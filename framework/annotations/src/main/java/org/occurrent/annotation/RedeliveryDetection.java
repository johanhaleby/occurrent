...
public enum RedeliveryDetection {
     ...
     * redelivery protection. Unless a broker bridge's {@code DeliveryFailurePolicy} stops the delivery being
     * redelivered, the broker offers the message again and the saga refuses
