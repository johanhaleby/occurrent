...
public enum Capability {
    /**
     * Events are received from all capabilities (both stream and DCB) on a store that supports both. This is the
     * agnostic, neutral default.
     */
    AGNOSTIC,
    /**
     * Only stream-written events are received, ignored on a DCB descriptor.
     */
    STREAM
}
