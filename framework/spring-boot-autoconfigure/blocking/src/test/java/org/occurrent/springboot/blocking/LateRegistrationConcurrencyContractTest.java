...
class LateRegistrationConcurrencyContractTest {
    ...
    //
    // Behaviour is covered by RegistrationRacingCloseTest. This only catches the field being removed or weakened,
    // which would leave the recheck reading a value it can miss.
    @Test
    void every_registrar_that_owns_something_close_stops_can_tell_a_registration_that_shutdown_began() throws Exception {
        ...
        assertVolatileClosingFlag(SagaAnnotationRegistrar.class);
    }
    ...
    void one_method_decides_both_whether_to_block_and_where_to_deliver() throws Exception {
        assertThat(OccurrentBlockingAnnotationBeanPostProcessor.class.getDeclaredMethod(
    ...
    void the_startup_handoff_carries_the_instance_alongside_the_name() throws Exception {
        Field field = OccurrentBlockingAnnotationBeanPostProcessor.class.getDeclaredField("builtWhileScanning");
