...
public class OccurrentReactiveAnnotationConfiguration {
     ...
     * <p>
     * Named after the stack, like {@link #occurrentReactiveAnnotationBeanPostProcessor()}, because the blocking
     * configuration declares its own {@code ManualStartPushSources} bean of a different, blocking-specific type. Bean
    ...
    @Conditional(OnSubscriptionsNotDisabledCondition.class)
    public ManualStartPushSources occurrentReactiveManualStartPushSources() {
