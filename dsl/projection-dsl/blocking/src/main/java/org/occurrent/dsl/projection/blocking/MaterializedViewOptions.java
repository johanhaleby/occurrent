...
/**
 * Tuning knobs for a {@link Projections#materializedView materialized view}. During a catch-up replay the view
 * coalesces updates per key rather than reading and writing once per event
 ...
 *                  and writes through per event, the same as a view with no coalescing at all, and is the way out for
 *                  anyone this default surprises.
 */
