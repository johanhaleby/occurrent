 ...
 */
fun <C : Any, S, E : Any> ApplicationService<E>.execute(streamId: String, command: C, decider: Decider<C, S, E>, store: SnapshotStore<S>, options: SnapshotOptions<S, E>): Mono<WriteResult> =
 ...
 */
fun <C : Any, S, E : Any> ApplicationService<E>.execute(streamId: String, commands: List<C>, decider: Decider<C, S, E>, store: SnapshotStore<S>, options: SnapshotOptions<S, E>): Mono<WriteResult> =
 ...
 */
fun <C : Any, S, E : Any> DcbApplicationService<E>.execute(command: C, dcbDecider: DcbDecider<C, S, E>, store: SnapshotStore<S>, options: SnapshotOptions<S, E>): Mono<DcbAppendResult> =
 ...
 */
fun <C : Any, S, E : Any> DcbApplicationService<E>.execute(commands: List<C>, dcbDecider: DcbDecider<C, S, E>, store: SnapshotStore<S>, options: SnapshotOptions<S, E>, keyFunction: (DcbCriteria) -> String = DcbCriteria::toString): Mono<DcbAppendResult> =
 ...
 */
fun <S : Any, E : Any> EventStore.readSnapshotState(converter: CloudEventConverter<E>, streamId: String, snapshotView: SnapshotView<S, E>, store: SnapshotStore<S>, policy: SnapshotPolicy<S, E>): Mono<S> =
