...
public final class DcbSubscriptions<E> {
    ...
    /**
     * Subscribes to live DCB events that match {@code criteria}, starting at {@code startAt}. When {@code waitUntilStarted}
    ...
    /**
     * Subscribes to live DCB events that match {@code criteria}, exposing DCB metadata to the callback.
     * <p>
