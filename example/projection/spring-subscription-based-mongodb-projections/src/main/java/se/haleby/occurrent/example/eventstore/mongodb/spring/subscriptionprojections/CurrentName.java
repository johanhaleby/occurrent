...
@TypeAlias("se.haleby.occurrent.example.eventstore.mongodb.spring.subscriptionprojections.CurrentName")
public class CurrentName {
    ...
    public String toString() {
        return "se.haleby.occurrent.example.eventstore.mongodb.spring.subscriptionprojections.CurrentName{" +
                "id='" + id + '\'' +
                ", name='" + name + '\'' +
                '}';
    }
