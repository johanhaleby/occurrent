...
class WhenGameEndedThenPublishIntegrationEvent {
    ...
    WhenGameEndedThenPublishIntegrationEvent(DomainEventQueries<GameEvent> domainEventQueries) {
    ...
    void publishIntegrationEventWhenGameEnded(EventMetadata metadata, NumberGuessingGameEnded numberGuessingGameEnded) {
        ...
        log.info("Publishing integration event {}", NumberGuessingGameCompleted.class.getSimpleName());
