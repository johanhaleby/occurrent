...
@Component
public class NumberOfStartedGames {

    AtomicInteger numberOfStartedGames = new AtomicInteger(0);

    public void increaseNumberOfStartedGames() {
        numberOfStartedGames.incrementAndGet();
    }

    public int get() {
        return numberOfStartedGames.get();
    }
}