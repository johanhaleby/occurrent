...
data class GameCreated(override val game: GameId, override val timestamp: Timestamp, val createdBy: GameCreatorId, val numberOfRounds: NumberOfRounds) : GameEvent
