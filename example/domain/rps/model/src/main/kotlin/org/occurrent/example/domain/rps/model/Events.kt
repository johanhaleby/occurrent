...
data class HandPlayed(override val game: GameId, override val timestamp: Timestamp, val player: PlayerId, val shape: Shape, val roundNumber: RoundNumber) : GameEvent
