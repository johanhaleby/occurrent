...
/**
 * The DCB queries that define the decision criteria for each command. A query is both the read filter (what the decider
 * folds its state from) and the consistency boundary (what a conditional append is checked against).
 */
internal object HotelBookingCriteria {
