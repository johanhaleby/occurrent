...
/** Releases a student's seat in a course. Same cross-entity boundary as enrolling. */
@Service
class UnenrollStudent(
    ...
    operator fun invoke(courseId: CourseId, studentId: StudentId, occurredAt: Instant = Instant.now()) {
        applicationService.execute(
            ...
            CourseEnrollmentCommand.UnenrollStudent(UUID.randomUUID(), occurredAt, courseId, studentId),
            decider
        )
    }
}
