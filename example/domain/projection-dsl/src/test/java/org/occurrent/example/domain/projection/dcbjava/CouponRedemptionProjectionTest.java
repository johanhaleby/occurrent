...
import static org.occurrent.example.domain.projection.dcbjava.CouponRedemption.isCouponRedeemedProjection;
...
class CouponRedemptionProjectionTest {
    ...
    void dcb_push_projection_materializes_the_tag_scoped_flag() {
        ...
        await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> assertThat(store.get("SAVE10")).isTrue());
    }
