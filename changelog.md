...
* Removed the automatic creation of the "streamId" index in all MongoDB event stores. The reason is that it's not needed since there's another (compound) index (streamId+version) that and 
