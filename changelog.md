...
* MongoDB event streams are now sorted by time specified in "_id" by default. The reason for this is that just relying on natural "sorting" on read lead to 
  wrong order on certain occasions.  
