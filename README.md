...
* You should be able to design your domain model without _any_ dependencies to Occurrent or any other library. Use Occurrent to store your events generated by the domain model.
