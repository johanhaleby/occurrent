...
@TypeAlias("se.haleby.occurrent.example.eventstore.mongodb.spring.changestreamedprojections.CurrentName")
public class CurrentName {
    ...
    public String toString() {
        return "se.haleby.occurrent.example.eventstore.mongodb.spring.changestreamedprojections.CurrentName{" +
                "id='" + id + '\'' +
                ", name='" + name + '\'' +
                '}';
    }
