...
Six things break, and only if you use the features they belong to.
...
[section 14](#14-a-saga-refuses-an-event-it-cannot-recognise-a-redelivery-of).
...
registered, every way a subscription model can refuse a call now has its own exception type, and a saga refuses an
event it cannot recognise a redelivery of.
...
## 14. A saga refuses an event it cannot recognise a redelivery of
