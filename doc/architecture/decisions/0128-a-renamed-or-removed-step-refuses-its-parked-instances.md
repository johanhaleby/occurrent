...
quarantined past `quarantineAfter` wherever the conditions `SagaStatus.QUARANTINED` lists hold, and
[ADR 134](0134-a-saga-instance-that-keeps-failing-is-quarantined-at-its-own-position.md) records the decision. Whether they
